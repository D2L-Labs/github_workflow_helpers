 ...
 */
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const http_client_1 = __nccwpck_require__(6936);
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const AWS = __nccwpck_require__(8437);
      const { Service } = AWS;
      const { apiLoader } = AWS;
      ...
      Object.defineProperty(apiLoader.services.cognitoidentity, '2014-06-30', {
        get: function get() {
          const model = __nccwpck_require__(7377);
          model.paginators = (__nccwpck_require__(5010)/* .pagination */ .o);
          return model;
        },
        enumerable: true,
        configurable: true,
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      Object.defineProperty(apiLoader.services.lambda, '2014-11-11', {
        get: function get() {
          const model = __nccwpck_require__(1251);
          model.paginators = (__nccwpck_require__(9210)/* .pagination */ .o);
          return model;
        },
        enumerable: true,
        configurable: true,
      ...
      Object.defineProperty(apiLoader.services.lambda, '2015-03-31', {
        get: function get() {
          const model = __nccwpck_require__(9103);
          model.paginators = (__nccwpck_require__(2057)/* .pagination */ .o);
          model.waiters = (__nccwpck_require__(626)/* .waiters */ .V);
          return model;
        },
        enumerable: true,
        configurable: true,
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      Object.defineProperty(apiLoader.services.sts, '2011-06-15', {
        get: function get() {
          const model = __nccwpck_require__(753);
          model.paginators = (__nccwpck_require__(6314)/* .pagination */ .o);
          return model;
        },
        enumerable: true,
        configurable: true,
 ...
 */
   ...
   */
        getCredentials: function getCredentials(callback) {
          ...
          function getAsyncCredentials() {
            self.credentials.get((err) => {
              if (err) {
                const msg = `Could not load credentials from ${
          ...
          if (self.credentials) {
            ...
            self.credentialProvider.resolve((err, creds) => {
              if (err) {
   ...
   */
        loadFromPath: function loadFromPath(path) {
          ...
          const options = JSON.parse(AWS.util.readFileSync(path));
          const fileSystemCreds = new AWS.FileSystemCredentials(path);
   ...
   */
        setPromisesDependency: function setPromisesDependency(dep) {
          ...
          const constructors = [AWS.Request, AWS.Credentials, AWS.CredentialProviderChain];
          if (AWS.S3) {
 ...
 */
      ...
      + ` or "regional". Got "${originalConfig[options.clientConfig]}".`,
        ...
        if (Object.prototype.hasOwnProperty.call(process.env, options.env)) {
          const envFlag = process.env[options.env];
      ...
      + ` or "regional". Got "${process.env[options.env]}".`,
        ...
        if (profile && Object.prototype.hasOwnProperty.call(profile, options.sharedConfig)) {
          const fileFlag = profile[options.sharedConfig];
 ...
 */
      const AWS = { util: __nccwpck_require__(7985) };
 ...
 */
      const _hidden = {}; _hidden.toString(); // hack to parse macro
 ...
 */
      ...
      AWS.util.memoizedProperty(AWS, 'endpointCache', () => new AWS.EndpointCache(AWS.config.endpointCacheSize), true);
      /***/ }),
 ...
 */
   ...
   */
        constructor: function Credentials() {
          ...
          if (arguments.length === 1 && typeof arguments[0] === 'object') {
            const creds = arguments[0].credentials || arguments[0];
   ...
   */
        needsRefresh: function needsRefresh() {
          const currentTime = AWS.util.date.getDate().getTime();
   ...
   */
        coalesceRefresh: function coalesceRefresh(callback, sync) {
          ...
          if (self.refreshCallbacks.push(callback) === 1) {
            self.load((err) => {
              AWS.util.arrayEach(self.refreshCallbacks, (callback) => {
                if (sync) {
                  callback(err);
                } else {
 ...
 */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const STS = __nccwpck_require__(7513);
 ...
 */
   ...
   */
        constructor: function ChainableTemporaryCredentials(options) {
          ...
          const params = AWS.util.copy(options.params) || {};
          if (params.RoleArn) {
   ...
   */
        load: function load(callback) {
          const self = this;
          const operation = self.service.config.params.RoleArn ? 'assumeRole' : 'getSessionToken';
          this.getTokenCode((err, tokenCode) => {
            const params = {};
            if (err) {
              callback(err);
              return;
            ...
            self.service[operation](params, (err, data) => {
              if (!err) {
   ...
   */
        getTokenCode: function getTokenCode(callback) {
          const self = this;
          if (this.tokenCodeFn) {
            this.tokenCodeFn(this.service.config.params.SerialNumber, (err, token) => {
              if (err) {
                let message = err;
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const CognitoIdentity = __nccwpck_require__(8291);
      const STS = __nccwpck_require__(7513);
 ...
 */
   ...
   */
        clearCachedId: function clearCache() {
          ...
          const poolId = this.params.IdentityPoolId;
          const loginId = this.params.LoginId || '';
   ...
   */
        getCredentialsForIdentity: function getCredentialsForIdentity(callback) {
          const self = this;
          self.cognito.getCredentialsForIdentity((err, data) => {
            if (!err) {
              self.cacheId(data);
              self.data = data;
   ...
   */
        getCredentialsFromSTS: function getCredentialsFromSTS(callback) {
          const self = this;
          self.cognito.getOpenIdToken((err, data) => {
            if (!err) {
              self.cacheId(data);
              self.params.WebIdentityToken = data.Token;
              self.webIdentityCredentials.refresh((webErr) => {
                if (!webErr) {
   ...
   */
        loadCachedId: function loadCachedId() {
          ...
          if (AWS.util.isBrowser() && !self.params.IdentityId) {
            const id = self.getStorage('id');
            if (id && self.params.Logins) {
              const actualProviders = Object.keys(self.params.Logins);
              const cachedProviders = (self.getStorage('providers') || '').split(',');

              // only load ID if at least one provider used this ID before
              const intersect = cachedProviders.filter((n) => actualProviders.indexOf(n) !== -1);
   ...
   */
      ...
      || new AWS.WebIdentityCredentials(this.params, clientConfig);
          if (!this.cognito) {
            const cognitoConfig = AWS.util.merge({}, clientConfig);
   ...
   */
        storage: (function () {
          try {
            const storage = AWS.util.isBrowser() && window.localStorage !== null && typeof window.localStorage === 'object'
              ? window.localStorage : {};
   ...
   */
        resolve: function resolve(callback) {
          ...
          if (self.resolveCallbacks.push(callback) === 1) {
            let index = 0;
            const providers = self.providers.slice(0);

            function resolveNext(err, creds) {
              if ((!err && creds) || index === providers.length) {
                AWS.util.arrayEach(self.resolveCallbacks, (callback) => {
                  callback(err, creds);
                });
 ...
 */
   ...
   */
        load: function load(callback) {
          const self = this;
          self.metadataService.loadCredentials((err, creds) => {
            if (!err) {
              const currentTime = AWS.util.date.getDate();
              const expireTime = new Date(creds.Expiration);
 ...
 */
   ...
   */
        refresh: function refresh(callback) {
          ...
          const keys = ['ACCESS_KEY_ID', 'SECRET_ACCESS_KEY', 'SESSION_TOKEN'];
          const values = [];
 ...
 */
   ...
   */
        refresh: function refresh(callback) {
          if (!callback) callback = AWS.util.fn.callback;
          try {
            const creds = JSON.parse(AWS.util.readFileSync(this.filename));
 ...
 */
   ...
   */
        load: function load(callback) {
          const self = this;
          try {
            const profiles = AWS.util.getProfilesFromSharedConfig(iniLoader, this.filename);
            ...
            if (profile.credential_process) {
              this.loadViaCredentialProcess(profile, (err, data) => {
                if (err) {
                  callback(err, null);
                } else {
                  self.expired = false;
  ...
  */
        loadViaCredentialProcess: function loadViaCredentialProcess(profile, callback) {
          proc.exec(profile.credential_process, { env: process.env }, (err, stdOut, stdErr) => {
            if (err) {
              callback(AWS.util.error(
              ...
              try {
                ...
                if (credData.Expiration) {
                  const currentTime = AWS.util.date.getDate();
                  const expireTime = new Date(credData.Expiration);
                  if (expireTime < currentTime) {
   ...
   */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const ENV_RELATIVE_URI = 'AWS_CONTAINER_CREDENTIALS_RELATIVE_URI';
      const ENV_FULL_URI = 'AWS_CONTAINER_CREDENTIALS_FULL_URI';
      const ENV_AUTH_TOKEN = 'AWS_CONTAINER_AUTHORIZATION_TOKEN';
      const FULL_URI_UNRESTRICTED_PROTOCOLS = ['https:'];
      const FULL_URI_ALLOWED_PROTOCOLS = ['http:', 'https:'];
      const FULL_URI_ALLOWED_HOSTNAMES = ['localhost', '127.0.0.1'];
      const RELATIVE_URI_HOST = '169.254.170.2';
 ...
 */
   ...
   */
        getECSFullUri: function getECSFullUri() {
          if (process && process.env) {
            const relative = process.env[ENV_RELATIVE_URI];
            const full = process.env[ENV_FULL_URI];
            if (relative) {
              return `http://${RELATIVE_URI_HOST}${relative}`;
            } if (full) {
              const parsed = AWS.util.urlParse(full);
   ...
   */
        request: function request(url, callback) {
          const httpRequest = new AWS.HttpRequest(url);
          httpRequest.method = 'GET';
          httpRequest.headers.Accept = 'application/json';
          const token = this.getECSAuthToken();
          if (token) {
 ...
 */
   ...
   */
        load: function load(callback) {
          const self = this;
          self.createClients();
          self.service.assumeRoleWithSAML((err, data) => {
            if (!err) {
              self.service.credentialsFrom(data, self);
            }
            callback(err);
 ...
 */
   ...
   */
      ...
      sdk.
      */
            const preferStaticCredentialsToRoleArn = Boolean(
        ...
        && profile.aws_secret_access_key,
            ...
            if (profile.role_arn && !preferStaticCredentialsToRoleArn) {
              this.loadRoleProfile(profiles, profile, (err, data) => {
                if (err) {
                  callback(err);
                } else {
                  self.expired = false;
   ...
   */
        loadRoleProfile: function loadRoleProfile(creds, roleProfile, callback) {
          ...
          const self = this;
          const roleArn = roleProfile.role_arn;
          const roleSessionName = roleProfile.role_session_name;
          const externalId = roleProfile.external_id;
          const mfaSerial = roleProfile.mfa_serial;
          const sourceProfileName = roleProfile.source_profile;
          ...
          const profileRegion = roleProfile.region || ASSUME_ROLE_DEFAULT_REGION;
          ...
          const sourceProfileExistanceTest = creds[sourceProfileName];
          ...
          if (mfaSerial && self.tokenCodeFn) {
            ...
            self.tokenCodeFn(mfaSerial, (err, token) => {
              if (err) {
                let message;
                if (err instanceof Error) {
                  message = err.message;
 ...
 */
   ...
   */
        load: function load(callback) {
          const self = this;
          self.createClients();
          self.masterCredentials.get(() => {
            self.service.config.credentials = self.masterCredentials;
            const operation = self.params.RoleArn
              ? self.service.assumeRole : self.service.getSessionToken;
            operation.call(self.service, (err, data) => {
              if (!err) {
                self.service.credentialsFrom(data, self);
              }
              callback(err);
 ...
 */
   ...
   */
        getParamsFromSharedConfig: function getParamsFromSharedConfig() {
          const profiles = AWS.util.getProfilesFromSharedConfig(iniLoader);
          const profileName = process.env.AWS_PROFILE || AWS.util.defaultProfile;
  ...
  */
        assumeRoleChaining: function assumeRoleChaining(paramsArray, callback) {
          ...
          if (paramsArray.length === 0) {
            ...
            const params = paramsArray.shift();
   ...
   */
        load: function load(callback) {
          const self = this;
          try {
            let paramsArray = self.getParamsFromEnv();
            if (!paramsArray) {
              paramsArray = self.getParamsFromSharedConfig();
            }
            if (paramsArray) {
              const params = paramsArray.shift();
              const oidcToken = fs.readFileSync(params.envTokenFile, { encoding: 'ascii' });
              if (!self.service) {
                self.createClients();
              }
   ...
   */
        createClients() {
          if (!this.service) {
            const stsConfig = AWS.util.merge({}, this.clientConfig);
 ...
 */
   ...
   */
        load: function load(callback) {
          const self = this;
          self.createClients();
          self.service.assumeRoleWithWebIdentity((err, data) => {
            self.data = null;
            if (!err) {
              self.data = data;
              self.service.credentialsFrom(data, self);
   ...
   */
        createClients() {
          if (!this.service) {
            const stsConfig = AWS.util.merge({}, this._clientConfig);
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const util = __nccwpck_require__(7985);
      const endpointDiscoveryEnabledEnvs = ['AWS_ENABLE_ENDPOINT_DISCOVERY', 'AWS_ENDPOINT_DISCOVERY_ENABLED'];
 ...
 */
      function marshallCustomIdentifiersHelper(result, params, shape) {
        ...
        if (shape.type === 'structure' && shape.required && shape.required.length > 0) {
          util.arrayEach(shape.required, (name) => {
            const memberShape = shape.members[name];
            if (memberShape.endpointDiscoveryId === true) {
              const locationName = memberShape.isLocationName ? memberShape.name : name;
 ...
 */
      function optionalDiscoverEndpoint(request) {
        const { service } = request;
        const { api } = service;
        const operationModel = api.operations ? api.operations[request.operation] : undefined;
        const inputShape = operationModel ? operationModel.input : undefined;

        const identifiers = marshallCustomIdentifiers(request, inputShape);
        let cacheKey = getCacheKey(request);
        if (Object.keys(identifiers).length > 0) {
          cacheKey = util.update(cacheKey, identifiers);
          if (operationModel) cacheKey.operation = operationModel.name;
        }
        const endpoints = AWS.endpointCache.get(cacheKey);
        if (endpoints && endpoints.length === 1 && endpoints[0].Address === '') {
          ...
          const endpointRequest = service.makeRequest(api.endpointOperation, {
 ...
 */
      function requiredDiscoverEndpoint(request, done) {
        ...
        const cacheKeyStr = AWS.EndpointCache.getKeyString(cacheKey);
        const endpoints = AWS.endpointCache.get(cacheKeyStr); // endpoint cache also accepts string keys
        if (endpoints && endpoints.length === 1 && endpoints[0].Address === '') {
          // endpoint operation is being made but response not yet received
          ...
          endpointRequest.send((err, data) => {
            if (err) {
              ...
              if (requestQueue[cacheKeyStr]) {
                ...
                util.arrayEach(pendingRequests, (requestContext) => {
 ...
 */
      function addApiVersionHeader(endpointRequest) {
        const { api } = endpointRequest.service;
 ...
 */
    ...
    && (error.code === 'InvalidEndpointException' || httpResponse.statusCode === 421)
          ...
          const operations = request.service.api.operations || {};
          const inputShape = operations[request.operation] ? operations[request.operation].input : undefined;
          const identifiers = marshallCustomIdentifiers(request, inputShape);
          let cacheKey = getCacheKey(request);
          if (Object.keys(identifiers).length > 0) {
            cacheKey = util.update(cacheKey, identifiers);
 ...
 */
      function hasCustomEndpoint(client) {
        ...
        const svcConfig = AWS.config[client.serviceIdentifier] || {};
 ...
 */
      function resolveEndpointDiscoveryConfig(request) {
        ...
        for (let i = 0; i < endpointDiscoveryEnabledEnvs.length; i++) {
          const env = endpointDiscoveryEnabledEnvs[i];
        ...
        const sharedFileConfig = configFile[
 ...
 */
      function discoverEndpoint(request, done) {
        ...
        const operations = service.api.operations || {};
        const operationModel = operations[request.operation];
        const isEndpointDiscoveryRequired = operationModel ? operationModel.endpointDiscoveryRequired : 'NULL';
        const isEnabled = resolveEndpointDiscoveryConfig(request);
        const { hasRequiredEndpointDiscovery } = service.api;
    ...
    /***/ 3727:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { eventMessageChunker } = __nccwpck_require__(3630);
      const { parseEvent } = __nccwpck_require__(2123);

      function createEventStream(body, parser, model) {
        const eventMessages = eventMessageChunker(body);
 ...
 */
    ...
    /***/ 8518:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { util } = __nccwpck_require__(8437);
      const { Transform } = __nccwpck_require__(2781);
      const allocBuffer = util.buffer.alloc;
 ...
 */
      function eventMessageChunker(buffer) {
        ...
        while (offset < buffer.length) {
          ...
          const message = buffer.slice(offset, totalLength + offset);
 ...
 */
      EventUnmarshallerStream.prototype._transform = function (chunk, encoding, callback) {
        try {
          const event = parseEvent(this.parser, chunk, this.eventStreamModel);
          this.push(event);
          return callback();
        } catch (err) {
          callback(err);
 ...
 */
    ...
    /***/ 2123:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { parseMessage } = __nccwpck_require__(866);
 ...
 */
      function parseEvent(parser, message, shape) {
        ...
        const messageType = parsedMessage.headers[':message-type'];
        if (messageType) {
        ...
        const eventType = parsedMessage.headers[':event-type'];
        // check that the event type is modeled
        const eventModel = shape.members[eventType.value];
        if (!eventModel) {
          return;
        }
        ...
        const { eventPayloadMemberName } = eventModel;
        if (eventPayloadMemberName) {
          const payloadShape = eventModel.members[eventPayloadMemberName];
        ...
        // read event headers
        const eventHeaderNames = eventModel.eventHeaderMemberNames;
        for (let i = 0; i < eventHeaderNames.length; i++) {
          const name = eventHeaderNames[i];
      ...
      function parseError(message) {
        const errorCode = message.headers[':error-code'];
        const errorMessage = message.headers[':error-message'];
        const error = new Error(errorMessage.value || errorMessage);
 ...
 */
    ...
    /***/ 866:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { Int64 } = __nccwpck_require__(8583);

      const { splitMessage } = __nccwpck_require__(1765);
 ...
 */
      function parseHeaders(headers) {
        ...
        while (position < headers.length) {
          const nameLength = headers.readUInt8(position++);
          const name = headers.slice(position, position + nameLength).toString();
          position += nameLength;
 ...
 */
      function splitMessage(message) {
        ...
        const expectedPreludeChecksum = message.readUInt32BE(PRELUDE_LENGTH);
        ...
        const expectedMessageChecksum = message.readUInt32BE(message.length - CHECKSUM_LENGTH);
        ...
        const headersStart = PRELUDE_LENGTH + CHECKSUM_LENGTH;
        const headersEnd = headersStart + message.readUInt32BE(PRELUDE_MEMBER_LENGTH);
 ...
 */
      ...
      const { EventMessageChunkerStream } = __nccwpck_require__(8518);
      const { EventUnmarshallerStream } = __nccwpck_require__(3773);

      function createEventStream(stream, parser, model) {
        const eventStream = new EventUnmarshallerStream({
          parser,
        ...
        eventMessageChunker.on('error', (err) => {
 ...
 */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const SequentialExecutor = __nccwpck_require__(5948);
      const DISCOVER_ENDPOINT = (__nccwpck_require__(5313).discoverEndpoint);
      /**
 ...
 */
      function getOperationAuthtype(req) {
        ...
        const operation = req.service.api.operations[req.operation];
        return operation ? operation.authtype : '';
      }

      AWS.EventListeners = {
        Core: new SequentialExecutor().addNamedListeners((add, addAsync) => {
          addAsync(
            'VALIDATE_CREDENTIALS',
            'validate',
            (req, done) => {
              if (!req.service.api.signatureVersion && !req.service.config.signatureVersion) return done(); // none
              req.service.config.getCredentials((err) => {
                if (err) {
          ...
          add('VALIDATE_REGION', 'validate', (req) => {
          ...
          add('BUILD_IDEMPOTENCY_TOKENS', 'validate', (req) => {
            if (!req.service.api.operations) {
              return;
            }
            const operation = req.service.api.operations[req.operation];
            ...
            const { idempotentMembers } = operation;
            if (!idempotentMembers.length) {
              return;
            }
            // creates a copy of params so user's param object isn't mutated
            const params = AWS.util.copy(req.params);
            for (let i = 0, iLen = idempotentMembers.length; i < iLen; i++) {
          ...
          add('VALIDATE_PARAMETERS', 'validate', (req) => {
            if (!req.service.api.operations) {
              return;
            }
            const rules = req.service.api.operations[req.operation].input;
            const validation = req.service.config.paramValidation;
            new AWS.ParamValidator(validation).validate(rules, req.params);
          });

          add('COMPUTE_CHECKSUM', 'afterBuild', (req) => {
            if (!req.service.api.operations) {
              return;
            }
            const operation = req.service.api.operations[req.operation];
            ...
            const { body } = req.httpRequest;
            const isNonStreamingPayload = body && (AWS.util.Buffer.isBuffer(body) || typeof body === 'string');
            const { headers } = req.httpRequest;
            if (
        ...
        && !headers['Content-MD5']
              ...
              const md5 = AWS.util.crypto.md5(body, 'base64');
              headers['Content-MD5'] = md5;
            }
          });

          addAsync('COMPUTE_SHA256', 'afterBuild', (req, done) => {
            req.haltHandlersOnError();
            if (!req.service.api.operations) {
              return;
            }
            const operation = req.service.api.operations[req.operation];
            const authtype = operation ? operation.authtype : '';
            if (!req.service.api.signatureVersion && !authtype && !req.service.config.signatureVersion) return done(); // none
            if (req.service.getSignerClass(req) === AWS.Signers.V4) {
              const body = req.httpRequest.body || '';
              if (authtype.indexOf('unsigned-body') >= 0) {
                req.httpRequest.headers['X-Amz-Content-Sha256'] = 'UNSIGNED-PAYLOAD';
                return done();
              }
              AWS.util.computeSha256(body, (err, sha) => {
                if (err) {
                  done(err);
                } else {
          ...
          add('SET_CONTENT_LENGTH', 'afterBuild', (req) => {
            const authtype = getOperationAuthtype(req);
            const payloadMember = AWS.util.getRequestPayloadShape(req);
            if (req.httpRequest.headers['Content-Length'] === undefined) {
              try {
                const length = AWS.util.string.byteLength(req.httpRequest.body);
          ...
          add('SET_HTTP_HOST', 'afterBuild', (req) => {
          ...
          const addToHead = true;
          addAsync('DISCOVER_ENDPOINT', 'sign', DISCOVER_ENDPOINT, addToHead);

          addAsync('SIGN', 'sign', (req, done) => {
            const { service } = req;
            const operations = req.service.api.operations || {};
            const operation = operations[req.operation];
            const authtype = operation ? operation.authtype : '';
            if (!service.api.signatureVersion && !authtype && !service.config.signatureVersion) return done(); // none

            service.config.getCredentials((err, credentials) => {
              if (err) {
              ...
              try {
                const date = service.getSkewCorrectedDate();
                const SignerClass = service.getSignerClass(req);
          ...
          addAsync('SEND', 'send', function SEND(resp, done) {
            ...
            function callback(httpResp) {
              ...
              const { stream } = resp.request.httpRequest;
              const { service } = resp.request;
              const { api } = service;
              const operationName = resp.request.operation;
              const operation = api.operations[operationName] || {};

              httpResp.on('headers', (statusCode, headers, statusMessage) => {
                resp.request.emit(
                  'httpHeaders',
            ...
            function progress(httpResp) {
              httpResp.on('sendProgress', (value) => {
                resp.request.emit('httpUploadProgress', [value, resp]);
              });

              httpResp.on('receiveProgress', (value) => {
            ...
            function error(err) {
              if (err.code !== 'RequestAbortedError') {
                const errCode = err.code === 'TimeoutError' ? err.code : 'NetworkingError';
              ...
              resp.error = err;
              resp.request.emit('httpError', [resp.error, resp], () => {
                done();
              });
            }

            function executeSend() {
              const http = AWS.HttpClient.getInstance();
              const httpOptions = resp.request.service.config.httpOptions || {};
              try {
                const stream = http.handleRequest(
            ...
            const timeDiff = (resp.request.service.getSkewCorrectedDate() - this.signedAt) / 1000;
            if (timeDiff >= 60 * 10) { // if we signed 10min ago, re-sign
              this.emit('sign', [this], (err) => {
                if (err) done(err);
                else executeSend();
              });
            } else {
          ...
          add('HTTP_DATA', 'httpData', (chunk, resp) => {
            if (chunk) {
              if (AWS.util.isNode()) {
                resp.httpResponse.numBytes += chunk.length;

                const total = resp.httpResponse.headers['content-length'];
                const progress = { loaded: resp.httpResponse.numBytes, total };
          ...
          add('HTTP_DONE', 'httpDone', (resp) => {
            // convert buffers array into single buffer
            if (resp.httpResponse.buffers && resp.httpResponse.buffers.length > 0) {
              const body = AWS.util.buffer.concat(resp.httpResponse.buffers);
          ...
          add('INVALIDATE_CREDENTIALS', 'retry', (resp) => {
          ...
          add('EXPIRED_SIGNATURE', 'retry', (resp) => {
          ...
          addAsync('RESET_RETRY_STATE', 'afterRetry', (resp, done) => {
            let delay; let
              willRetry = false;
        ...
        CorePost: new SequentialExecutor().addNamedListeners((add) => {
          ...
          && ['EAI_NONAME', 'EAI_NODATA'].indexOf(AWS.util.getSystemErrorName(err.errno) >= 0);
            ...
            if (err.code === 'NetworkingError' && isDNSError(err)) {
              const message = `Inaccessible host: \`${err.hostname}' at port \`${err.port
        ...
        Logger: new SequentialExecutor().addNamedListeners((add) => {
          add('LOG_REQUEST', 'complete', (resp) => {
            const req = resp.request;
            const { logger } = req.service.config;
            if (!logger) return;
            function filterSensitiveLog(inputShape, shape) {
              ...
              switch (inputShape.type) {
                case 'structure':
                  var struct = {};
                  AWS.util.each(shape, (subShapeName, subShape) => {
                ...
                case 'list':
                  var list = [];
                  AWS.util.arrayEach(shape, (subShape, index) => {
                    list.push(filterSensitiveLog(inputShape.member, subShape));
                  });
                  return list;
                case 'map':
                  var map = {};
                  AWS.util.each(shape, (key, value) => {
            ...
            function buildMessage() {
              const time = resp.request.service.getSkewCorrectedDate().getTime();
              const delta = (time - req.startTime.getTime()) / 1000;
              const ansi = !!logger.isTTY;
              const status = resp.httpResponse.statusCode;
              let censoredParams = req.params;
              if (
                req.service.api.operations
              && req.service.api.operations[req.operation]
              && req.service.api.operations[req.operation].input
              ) {
                const inputShape = req.service.api.operations[req.operation].input;
                censoredParams = filterSensitiveLog(inputShape, req.params);
              }
              const params = (__nccwpck_require__(3837).inspect)(censoredParams, true, null);
              let message = '';
        ...
        Json: new SequentialExecutor().addNamedListeners((add) => {
          const svc = __nccwpck_require__(83);
          add('BUILD', 'build', svc.buildRequest);
          add('EXTRACT_DATA', 'extractData', svc.extractData);
          add('EXTRACT_ERROR', 'extractError', svc.extractError);
        }),

        Rest: new SequentialExecutor().addNamedListeners((add) => {
          const svc = __nccwpck_require__(8200);
          add('BUILD', 'build', svc.buildRequest);
          add('EXTRACT_DATA', 'extractData', svc.extractData);
          add('EXTRACT_ERROR', 'extractError', svc.extractError);
        }),

        RestJson: new SequentialExecutor().addNamedListeners((add) => {
          const svc = __nccwpck_require__(5883);
          add('BUILD', 'build', svc.buildRequest);
          add('EXTRACT_DATA', 'extractData', svc.extractData);
          add('EXTRACT_ERROR', 'extractError', svc.extractError);
        }),

        RestXml: new SequentialExecutor().addNamedListeners((add) => {
          const svc = __nccwpck_require__(5143);
          add('BUILD', 'build', svc.buildRequest);
          add('EXTRACT_DATA', 'extractData', svc.extractData);
          add('EXTRACT_ERROR', 'extractError', svc.extractError);
        }),

        Query: new SequentialExecutor().addNamedListeners((add) => {
          const svc = __nccwpck_require__(761);
          add('BUILD', 'build', svc.buildRequest);
          add('EXTRACT_DATA', 'extractData', svc.extractData);
          add('EXTRACT_ERROR', 'extractError', svc.extractError);
        }),
   ...
   */
        constructor: function Endpoint(endpoint, config) {
          ...
          if (!endpoint.match(/^http/)) {
            const useSSL = config && config.sslEnabled !== undefined
 ...
 */
   ...
   */
        ...
        getUserAgentHeaderName: function getUserAgentHeaderName() {
          const prefix = AWS.util.isBrowser() ? 'X-Amz-' : '';
   ...
   */
        updateEndpoint: function updateEndpoint(endpointStr) {
          const newEndpoint = new AWS.Endpoint(endpointStr);
 ...
 */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const { Stream } = AWS.util.stream;
      const TransformStream = AWS.util.stream.Transform;
      const ReadableStream = AWS.util.stream.Readable;
      __nccwpck_require__(1556);
      const CONNECTION_REUSE_ENV_NAME = 'AWS_NODEJS_CONNECTION_REUSE_ENABLED';
 ...
 */
      AWS.NodeHttpClient = AWS.util.inherit({
        handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
          ...
          const http = useSSL ? __nccwpck_require__(5687) : __nccwpck_require__(3685);
          const options = {
          ...
          if (!httpOptions.agent) {
            options.agent = this.getAgent(useSSL, {
              keepAlive: process.env[CONNECTION_REUSE_ENV_NAME] === '1',
            });
          }
          ...
          var stream = http.request(options, (httpResp) => {
          ...
          stream.setTimeout(httpOptions.timeout || 0, () => {
            ...
            const msg = `Connection timed out after ${httpOptions.timeout}ms`;
          ...
          const expect = httpRequest.headers.Expect || httpRequest.headers.expect;
        ...
        writeBody: function writeBody(stream, httpRequest) {
          ...
          const totalBytes = parseInt(httpRequest.headers['Content-Length'], 10);

          if (body instanceof Stream) {
            // For progress support of streaming content -
            // pipe the data through a transform stream to emit 'sendProgress' events
            const progressStream = this.progressStream(stream, totalBytes);
            if (progressStream) {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function translateStructure(structure, shape) {
        ...
        const struct = {};
        util.each(structure, (name, value) => {
          const memberShape = shape.members[name];
          if (memberShape) {
            if (memberShape.location !== 'body') return;
            const locationName = memberShape.isLocationName ? memberShape.name : name;
            const result = translate(value, memberShape);
      ...
      function translateList(list, shape) {
        const out = [];
        util.arrayEach(list, (value) => {
          const result = translate(value, shape.member);
      ...
      function translateMap(map, shape) {
        const out = {};
        util.each(map, (key, value) => {
          const result = translate(value, shape.value);
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function translateStructure(structure, shape) {
        ...
        const struct = {};
        const shapeMembers = shape.members;
        util.each(shapeMembers, (name, memberShape) => {
          const locationName = memberShape.isLocationName ? memberShape.name : name;
          if (Object.prototype.hasOwnProperty.call(structure, locationName)) {
            const value = structure[locationName];
            const result = translate(value, memberShape);
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      __nccwpck_require__(1556);
      const { inherit } = AWS.util;
      const getMetadataServiceEndpoint = __nccwpck_require__(608);
 ...
 */
   ...
   */
        request: function request(path, options, callback) {
          ...
          const httpRequest = new AWS.HttpRequest(this.endpoint + path);
  ...
  */
   ...
   */
        fetchMetadataToken: function fetchMetadataToken(callback) {
          const self = this;
          const tokenFetchPath = '/latest/api/token';
          self.request(
            tokenFetchPath,
            {
              method: 'PUT',
   ...
   */
        fetchCredentials: function fetchCredentials(options, cb) {
          const self = this;
          const basePath = '/latest/meta-data/iam/security-credentials/';

          self.request(basePath, options, (err, roleName) => {
            if (err) {
            ...
            self.request(basePath + roleName, options, (credErr, credData) => {
              if (credErr) {
   ...
   */
        loadCredentials: function loadCredentials(callback) {
          ...
          if (self.disableFetchToken) {
            ...
            self.fetchMetadataToken((tokenError, token) => {
              if (tokenError) {
 ...
 */
    ...
    /***/ ((module) => {
      ...
      const getEndpointConfigOptions = function () {
        return {
          environmentVariableSelector(env) { return env[ENV_ENDPOINT_NAME]; },
          configFileSelector(profile) { return profile[CONFIG_ENDPOINT_NAME]; },
          default: undefined,
        };
      };
    ...
    /***/ 7997:
    /***/ ((module) => {
      const getEndpointMode = function () {
        return {
          IPv4: 'IPv4',
          IPv6: 'IPv6',
        };
    ...
    /***/ 5509:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const EndpointMode = __nccwpck_require__(7997)();

      const ENV_ENDPOINT_MODE_NAME = 'AWS_EC2_METADATA_SERVICE_ENDPOINT_MODE';
      const CONFIG_ENDPOINT_MODE_NAME = 'ec2_metadata_service_endpoint_mode';

      const getEndpointModeConfigOptions = function () {
        return {
          environmentVariableSelector(env) { return env[ENV_ENDPOINT_MODE_NAME]; },
          configFileSelector(profile) { return profile[CONFIG_ENDPOINT_MODE_NAME]; },
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const Endpoint = __nccwpck_require__(3205)();
      const EndpointMode = __nccwpck_require__(7997)();

      const ENDPOINT_CONFIG_OPTIONS = __nccwpck_require__(5578)();
      const ENDPOINT_MODE_CONFIG_OPTIONS = __nccwpck_require__(5509)();

      const getMetadataServiceEndpoint = function () {
        const endpoint = AWS.util.loadConfig(ENDPOINT_CONFIG_OPTIONS);
        if (endpoint !== undefined) return endpoint;

        const endpointMode = AWS.util.loadConfig(ENDPOINT_MODE_CONFIG_OPTIONS);
        switch (endpointMode) {
    ...
    /***/ 7657:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const Collection = __nccwpck_require__(1965);
      const Operation = __nccwpck_require__(8083);
      const Shape = __nccwpck_require__(1349);
      const Paginator = __nccwpck_require__(5938);
      const ResourceWaiter = __nccwpck_require__(1368);
      const metadata = __nccwpck_require__(7752);

      const util = __nccwpck_require__(7985);
      const { property } = util;
      const { memoizedProperty } = util;
      ...
      function Api(api, options) {
        ...
        const { serviceIdentifier } = options;
        ...
        memoizedProperty(this, 'className', () => {
        ...
        property(this, 'operations', new Collection(api.operations, options, ((name, operation) => new Operation(name, operation, options)), util.string.lowerFirst, addEndpointOperation));

        property(this, 'shapes', new Collection(api.shapes, options, ((name, shape) => Shape.create(shape, options))));

        property(this, 'paginators', new Collection(api.paginators, options, ((name, paginator) => new Paginator(name, paginator, options))));

        property(this, 'waiters', new Collection(api.waiters, options, ((name, waiter) => new ResourceWaiter(name, waiter, options)), util.string.lowerFirst));
 ...
 */
    ...
    /***/ 1965:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { memoizedProperty } = __nccwpck_require__(7985);

      function memoize(name, value, factory, nameTr) {
        memoizedProperty(this, nameTr(name), () => factory(name, value));
      }
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function Operation(name, operation, options) {
        ...
        memoizedProperty(this, 'errors', () => {
          const list = [];
          if (!operation.errors) return null;

          for (let i = 0; i < operation.errors.length; i++) {
        ...
        memoizedProperty(this, 'paginator', () => options.api.paginators[name]);
        ...
        memoizedProperty(this, 'idempotentMembers', () => {
          const idempotentMembers = [];
          const { input } = self;
          const { members } = input;
          if (!input.members) {
        ...
        memoizedProperty(this, 'hasEventOutput', () => {
          const { output } = self;
      ...
      function hasEventStream(topLevelShape) {
        const { members } = topLevelShape;
        const { payload } = topLevelShape;
 ...
 */
    ...
    /***/ 5938:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { property } = __nccwpck_require__(7985);
 ...
 */
      ...
      Shape.create = function create(shape, options, memberName) {
        ...
        if (refShape) {
          ...
          if (!options.documentation) {
            filteredKeys = filteredKeys.filter((name) => !name.match(/documentation/));
          }
      ...
      function StructureShape(shape, options) {
        ...
        if (firstInit) {
          ...
          property(this, 'isRequired', () => false);
          property(this, 'isDocument', Boolean(shape.document));
        }

        if (shape.members) {
          property(this, 'members', new Collection(shape.members, options, ((name, member) => Shape.create(member, options, name))));
          memoizedProperty(this, 'memberNames', () => shape.xmlOrder || Object.keys(shape.members));

          if (shape.event) {
            memoizedProperty(this, 'eventPayloadMemberName', () => {
              const { members } = self;
              const { memberNames } = self;
            ...
            memoizedProperty(this, 'eventHeaderMemberNames', () => {
              const { members } = self;
              const { memberNames } = self;
      ...
      function ListShape(shape, options) {
        ...
        if (shape.member) {
          memoizedProperty(this, 'member', () => Shape.create(shape.member, options));
        }

        if (this.flattened) {
          const oldName = this.name;
          memoizedProperty(this, 'name', () => self.member.name || oldName);
        }
      }
      ...
      function MapShape(shape, options) {
        ...
        if (shape.key) {
          memoizedProperty(this, 'key', () => Shape.create(shape.key, options));
        }
        if (shape.value) {
          memoizedProperty(this, 'value', () => Shape.create(shape.value, options));
        }
      }
      ...
      function BinaryShape() {
        Shape.apply(this, arguments);
        this.toType = function (value) {
          let buf = util.base64.decode(value);
   ...
   */
            const secureBuf = util.Buffer.alloc(buf.length, buf);
            buf.fill(0);
            buf = secureBuf;
          }
          return buf;
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const region_utils = __nccwpck_require__(9517);
      const { isFipsRegion } = region_utils;
      const { getRealRegion } = region_utils;
      ...
      util.loadConfig = function (options) {
        const envValue = options.environmentVariableSelector(process.env);
        ...
        const configValue = options.configFileSelector(sharedFileConfig);
 ...
 */
      ...
      const getRegion = function () {
        const { env } = process;
        let region = env.AWS_REGION || env.AMAZON_REGION;
        if (env[AWS.util.configOptInEnv]) {
          ...
          while (!region && toCheck.length) {
            let configFile = {};
            const fileInfo = toCheck.shift();
            try {
              configFile = iniLoader.loadFrom(fileInfo);
            } catch (err) {
              if (fileInfo.isConfig) throw err;
            }
            const profile = configFile[env.AWS_PROFILE || AWS.util.defaultProfile];
      ...
      const getBooleanValue = function (value) {
        return value === 'true' ? true : value === 'false' ? false : undefined;
      };

      const USE_FIPS_ENDPOINT_CONFIG_OPTIONS = {
      ...
      const USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS = {
        environmentVariableSelector(env) {
 ...
 */
   ...
   */
        ...
        validateStructure: function validateStructure(shape, params, context) {
          ...
          let paramName;
          for (let i = 0; shape.required && i < shape.required.length; i++) {
          ...
          for (paramName in params) {
            ...
            const memberShape = shape.members[paramName];

            if (memberShape !== undefined) {
              const memberContext = [context, paramName].join('.');
        ...
        validateType: function validateType(value, context, acceptedTypes, type) {
          ...
          const vowel = acceptedType.match(/^[aeiou]/i) ? 'n' : '';
        ...
        validatePayload: function validatePayload(value, context) {
          ...
          } else if (typeof Blob !== void 0 && value instanceof Blob) return;

          const types = ['Buffer', 'Stream', 'File', 'Blob', 'ArrayBuffer', 'DataView'];
          if (value) {
 ...
 */
      function populateHostPrefix(request) {
        const enabled = request.service.config.hostPrefixEnabled;
        if (!enabled) return request;
        const operationModel = request.service.api.operations[request.operation];
        // don't marshal host prefix when operation has endpoint discovery traits
        if (hasEndpointDiscover(request)) return request;
        if (operationModel.endpoint && operationModel.endpoint.hostPrefix) {
          const hostPrefixNotation = operationModel.endpoint.hostPrefix;
          const hostPrefix = expandHostPrefix(hostPrefixNotation, request.params, operationModel.input);
 ...
 */
      function hasEndpointDiscover(request) {
        const { api } = request.service;
        const operationModel = api.operations[request.operation];
        const isEndpointOperation = api.endpointOperation && (api.endpointOperation === util.string.lowerFirst(operationModel.name));
 ...
 */
      function expandHostPrefix(hostPrefixNotation, params, shape) {
        util.each(shape.members, (name, member) => {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const util = __nccwpck_require__(7985);
      const JsonBuilder = __nccwpck_require__(7495);
      const JsonParser = __nccwpck_require__(5474);
      const { populateHostPrefix } = __nccwpck_require__(7969);

      function buildRequest(req) {
        const { httpRequest } = req;
        const { api } = req.service;
        const target = `${api.targetPrefix}.${api.operations[req.operation].name}`;
        let version = api.jsonVersion || '1.0';
        const { input } = api.operations[req.operation];
      ...
      function extractError(resp) {
        ...
        if (httpResponse.body.length > 0) {
          try {
            const e = JSON.parse(httpResponse.body.toString());
            const code = e.__type || e.code || e.Code;
            if (code) {
      ...
      function extractData(resp) {
        const body = resp.httpResponse.body.toString() || '{}';
        if (resp.request.service.config.convertResponseTypes === false) {
          resp.data = JSON.parse(body);
        } else {
          const operation = resp.request.service.api.operations[resp.request.operation];
          const shape = operation.output || {};
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const util = __nccwpck_require__(7985);
      const QueryParamSerializer = __nccwpck_require__(5175);
      const Shape = __nccwpck_require__(1349);
      const { populateHostPrefix } = __nccwpck_require__(7969);
      ...
      function buildRequest(req) {
        ...
        const builder = new QueryParamSerializer();
        builder.serialize(req.params, operation.input, (name, value) => {
      ...
      function extractData(resp) {
        const req = resp.request;
        const operation = req.service.api.operations[req.operation];
        let shape = operation.output || {};
        const origRules = shape;

        if (origRules.resultWrapper) {
          const tmp = Shape.create({ type: 'structure' });
        ...
        const parser = new AWS.XML.Parser();

        // TODO: Refactor XML Parser to parse RequestId from response.
        if (shape && shape.members && !shape.members._XAMZRequestId) {
          const requestIdShape = Shape.create(
            { type: 'string' },
            { api: { protocol: 'query' } },
            'requestId',
          );
        ...
        const data = parser.parse(resp.httpResponse.body.toString(), shape);
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function generateURI(endpointPath, operationPath, input, params) {
        let uri = [endpointPath, operationPath].join('/');
        uri = uri.replace(/\/+/g, '/');

        const queryString = {}; let
          queryStringSet = false;
        util.each(input.members, (name, member) => {
          const paramValue = params[name];
          if (paramValue === null || paramValue === undefined) return;
          if (member.location === 'uri') {
            const regex = new RegExp(`\\{${member.name}(\\+)?\\}`);
            uri = uri.replace(regex, (_, plus) => {
              const fn = plus ? util.uriEscapePath : util.uriEscape;
            ...
            if (member.type === 'list') {
              queryString[member.name] = paramValue.map((val) => util.uriEscape(member.member.toWireFormat(val).toString()));
            } else if (member.type === 'map') {
              util.each(paramValue, (key, value) => {
                if (Array.isArray(value)) {
                  queryString[key] = value.map((val) => util.uriEscape(String(val)));
                } else {
        ...
        if (queryStringSet) {
          uri += (uri.indexOf('?') >= 0 ? '&' : '?');
          const parts = [];
          util.arrayEach(Object.keys(queryString).sort(), (key) => {
      ...
      function populateURI(req) {
        ...
        const uri = generateURI(req.httpRequest.endpoint.path, operation.httpPath, input, req.params);
        req.httpRequest.path = uri;
      }

      function populateHeaders(req) {
        const operation = req.service.api.operations[req.operation];
        util.each(operation.input.members, (name, member) => {
          let value = req.params[name];
          if (value === null || value === undefined) return;

          if (member.location === 'headers' && member.type === 'map') {
            util.each(value, (key, memberValue) => {
      ...
      function extractData(resp) {
        const req = resp.request;
        const data = {};
        const r = resp.httpResponse;
        const operation = req.service.api.operations[req.operation];
        const { output } = operation;

        // normalize headers names to lower-cased keys for matching
        const headers = {};
        util.each(r.headers, (k, v) => {
          headers[k.toLowerCase()] = v;
        });

        util.each(output.members, (name, member) => {
          const header = (member.name || name).toLowerCase();
          if (member.location === 'headers' && member.type === 'map') {
            data[name] = {};
            const location = member.isLocationName ? member.name : '';
            const pattern = new RegExp(`^${location}(.+)`, 'i');
            util.each(r.headers, (k, v) => {
              const result = k.match(pattern);
              if (result !== null) {
            ...
            if (headers[header] !== undefined) {
              const value = member.isJsonValue
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const util = __nccwpck_require__(7985);
      const Rest = __nccwpck_require__(8200);
      const Json = __nccwpck_require__(83);
      const JsonBuilder = __nccwpck_require__(7495);
      const JsonParser = __nccwpck_require__(5474);

      function populateBody(req) {
        const builder = new JsonBuilder();
        const { input } = req.service.api.operations[req.operation];

        if (input.payload) {
          let params = {};
          const payloadShape = input.members[input.payload];
      ...
      function applyContentTypeHeader(req, isBinary) {
        if (!req.httpRequest.headers['Content-Type']) {
          const type = isBinary ? 'binary/octet-stream' : 'application/json';
      ...
      function extractData(resp) {
        ...
        const req = resp.request;
        const operation = req.service.api.operations[req.operation];
        const rules = req.service.api.operations[req.operation].output || {};
        var parser;
        const { hasEventOutput } = operation;

        if (rules.payload) {
          const payloadMember = rules.members[rules.payload];
          const { body } = resp.httpResponse;
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function populateBody(req) {
        const { input } = req.service.api.operations[req.operation];
        const builder = new AWS.XML.Builder();
        let { params } = req;

        const { payload } = input;
        if (payload) {
          const payloadMember = input.members[payload];
          params = params[payload];
          if (params === undefined) return;

          if (payloadMember.type === 'structure') {
            const rootElement = payloadMember.name;
      ...
      function extractData(resp) {
        ...
        if (payload) {
          const payloadMember = output.members[payload];
          if (payloadMember.isEventStream) {
          ...
          parser = new AWS.XML.Parser();
          const data = parser.parse(body.toString(), output);
 ...
 */
      function fromConfigFile(config) {
        ...
        try {
          const configFile = AWS.util.iniLoader.loadFrom({
            isConfig: true,
            filename: process.env[AWS.util.sharedConfigFileEnv],
          });
 ...
 */
      function toJSType(config) {
        ...
        const falsyNotations = ['false', '0', undefined];
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { util } = __nccwpck_require__(8437);
      const dgram = __nccwpck_require__(1891);
      const stringToBuffer = util.buffer.toBuffer;

      const MAX_MESSAGE_SIZE = 1024 * 8; // 8 KB
 ...
 */
      Publisher.prototype.trimFields = function (event) {
        const trimmableFields = Object.keys(this.fieldsToTrim);
        for (let i = 0, iLen = trimmableFields.length; i < iLen; i++) {
          const field = trimmableFields[i];
          if (event.hasOwnProperty(field)) {
            const maxLength = this.fieldsToTrim[field];
 ...
 */
      Publisher.prototype.eventHandler = function (event) {
        ...
        const message = stringToBuffer(JSON.stringify(event));
 ...
 */
      Publisher.prototype.publishDatagram = function (message) {
        ...
        this.client.send(message, 0, message.length, this.port, this.address, (err, bytes) => {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function serializeStructure(prefix, struct, rules, fn) {
        util.each(rules.members, (name, member) => {
          const value = struct[name];
          if (value === null || value === undefined) return;

          let memberName = ucfirst(member);
      ...
      function serializeMap(name, map, rules, fn) {
        let i = 1;
        util.each(map, (key, value) => {
          const prefix = rules.flattened ? '.' : '.entry.';
          const position = `${prefix + (i++)}.`;
          const keyName = position + (rules.key.name || 'key');
          const valueName = position + (rules.value.name || 'value');
      ...
      function serializeList(name, list, rules, fn) {
        const memberRules = rules.member || {};
        ...
        util.arrayEach(list, (v, n) => {
          let suffix = `.${n + 1}`;
          if (rules.api.protocol === 'ec2') {
            // Do nothing for EC2
            suffix += ''; // make linter happy
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const util = __nccwpck_require__(7985);
      const regionConfig = __nccwpck_require__(738);
      ...
      function derivedKeys(service) {
        ...
        const regionPrefix = generateRegionPrefix(region);
        const { endpointPrefix } = service.api;
      ...
      function configureEndpoint(service) {
        const keys = derivedKeys(service);
        const { useFipsEndpoint } = service.config;
        const { useDualstackEndpoint } = service.config;
        for (let i = 0; i < keys.length; i++) {
          const key = keys[i];
          if (!key) continue;

          const rules = useFipsEndpoint
            ? useDualstackEndpoint
      ...
      function getEndpointSuffix(region) {
        ...
        const defaultSuffix = 'amazonaws.com';
        const regexes = Object.keys(regionRegexes);
        for (let i = 0; i < regexes.length; i++) {
          const regionPattern = RegExp(regexes[i]);
          const dnsSuffix = regionRegexes[regexes[i]];
 ...
 */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const AcceptorStateMachine = __nccwpck_require__(8118);
      const { inherit } = AWS.util;
      const { domain } = AWS.util;
      const jmespath = __nccwpck_require__(7783);

      /**
 * @api private
 */
      const hardErrorStates = { success: 1, error: 1, complete: 1 };

      function isTerminalState(machine) {
        return Object.prototype.hasOwnProperty.call(hardErrorStates, machine._asm.currentState);
      }

      const fsm = new AcceptorStateMachine();
      fsm.setupStates = function () {
        const transition = function (_, done) {
          const self = this;
          self._haltHandlersOnError = false;

          self.emit(self._asm.currentState, (err) => {
            if (err) {
 ...
 */
   ...
   */
        constructor: function Request(service, operation, params) {
          ...
          let { region } = service.config;
          const { customUserAgent } = service.config;
   ...
   */
        eachPage: function eachPage(callback) {
          ...
          function wrappedCallback(response) {
            callback.call(response, response.error, response.data, (result) => {
   ...
   */
        eachItem: function eachItem(callback) {
          ...
          function wrappedCallback(err, data) {
            ...
            const config = self.service.paginationConfig(self.operation);
            let { resultKey } = config;
            if (Array.isArray(resultKey)) resultKey = resultKey[0];
            const items = jmespath.search(data, resultKey);
            let continueIteration = true;
            AWS.util.arrayEach(items, (item) => {
   ...
   */
        createReadStream: function createReadStream() {
          ...
          this.on('httpHeaders', (statusCode, headers, resp) => {
            if (statusCode < 300) {
              req.removeListener('httpData', AWS.EventListeners.Core.HTTP_DATA);
              req.removeListener('httpError', AWS.EventListeners.Core.HTTP_ERROR);
              req.on('httpError', (error) => {
                resp.error = error;
                resp.error.retryable = false;
              });

              let shouldCheckContentLength = false;
              let expectedLen;
              ...
              const checkContentLengthAndEmit = function checkContentLengthAndEmit() {
              ...
              if (AWS.HttpClient.streamsApiVersion === 2) {
                if (shouldCheckContentLength) {
                  const lengthAccumulator = new streams.PassThrough();
   ...
   */
        emitEvent: function emit(eventName, args, done) {
          ...
          const origEmit = AWS.SequentialExecutor.prototype.emit;
 ...
 */
      function CHECK_ACCEPTORS(resp) {
        const waiter = resp.request._waiter;
        const { acceptors } = waiter.config;
        let acceptorMatched = false;
        let state = 'retry';

        acceptors.forEach((acceptor) => {
          if (!acceptorMatched) {
            const matcher = waiter.matchers[acceptor.matcher];
 ...
 */
   ...
   */
        ...
        matchers: {
          ...
          pathAll(resp, expected, argument) {
            try {
            ...
            for (let ind = 0; ind < numResults; ind++) {
          ...
          pathAny(resp, expected, argument) {
            try {
              var results = jmespath.search(resp.data, argument);
            } catch (err) {
              return false;
          ...
          status(resp, expected) {
            const { statusCode } = resp.httpResponse;
        ...
        listeners: new AWS.SequentialExecutor().addNamedListeners((add) => {
          add('RETRY_CHECK', 'retry', (resp) => {
            const waiter = resp.request._waiter;
   ...
   */
        wait: function wait(params, callback) {
          ...
          const request = this.service.makeRequest(this.config.operation, params);
 ...
 */
   ...
   */
        nextPage: function nextPage(callback) {
          ...
          const params = AWS.util.copy(this.request.params);
          if (!this.nextPageTokens) {
            return callback ? callback(null, null) : null;
          }
          let inputTokens = config.inputToken;
   ...
   */
        cacheNextPageTokens: function cacheNextPageTokens() {
          ...
          const config = this.request.service.paginationConfig(this.request.operation);
          ...
          let exprs = config.outputToken;
          if (typeof exprs === 'string') exprs = [exprs];
          AWS.util.arrayEach.call(this, exprs, function (expr) {
            const output = jmespath.search(this.data, expr);
            if (output) {
 ...
 */
   ...
   */
        addListeners: function addListeners(listeners) {
          ...
          AWS.util.each(listeners, (event, callbacks) => {
            if (typeof callbacks === 'function') callbacks = [callbacks];
            AWS.util.arrayEach(callbacks, (callback) => {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const Api = __nccwpck_require__(7657);
      const regionConfig = __nccwpck_require__(8262);
 ...
 */
   ...
   */
        ...
        && typeof config.useDualstackEndpoint !== 'boolean') {
          ...
          const ServiceClass = this.loadServiceClass(config || {});
          if (ServiceClass) {
            const originalConfig = AWS.util.copy(config);
            const svc = new ServiceClass(config);
   ...
   */
        initialize: function initialize(config) {
          const svcConfig = AWS.config[this.serviceIdentifier];
          ...
          if ((this.config.clientSideMonitoring || AWS.Service._clientSideMonitoring) && this.publisher) {
            ...
            this.addNamedListener('PUBLISH_API_CALL', 'apiCall', (event) => {
              process.nextTick(() => { publisher.eventHandler(event); });
            });
            this.addNamedListener('PUBLISH_API_ATTEMPT', 'apiCallAttempt', (event) => {
              process.nextTick(() => { publisher.eventHandler(event); });
            });
          }
        },
   ...
   */
        loadServiceClass: function loadServiceClass(serviceConfig) {
          ...
          let version = config.apiVersions[this.constructor.serviceIdentifier];
   ...
   */
        getLatestServiceVersion: function getLatestServiceVersion(version) {
          ...
          const keys = Object.keys(this.constructor.services).sort();
   ...
   */
        makeRequest: function makeRequest(operation, params, callback) {
          ...
          if (this.config.params) { // copy only toplevel bound params
            const rules = this.api.operations[operation];
            if (rules) {
              params = AWS.util.copy(params);
              AWS.util.each(this.config.params, (key, value) => {
          ...
          const request = new AWS.Request(this, operation, params);
   ...
   */
        makeUnauthenticatedRequest: function makeUnauthenticatedRequest(operation, params, callback) {
          ...
          const request = this.makeRequest(operation, params).toUnauthenticated();
   ...
   */
        waitFor: function waitFor(state, params, callback) {
          const waiter = new AWS.ResourceWaiter(this, state);
   ...
   */
        addAllRequestListeners: function addAllRequestListeners(request) {
          const list = [AWS.events, AWS.EventListeners.Core, this.serviceInterface(),
   ...
   */
        apiCallEvent: function apiCallEvent(request) {
          const api = request.service.api.operations[request.operation];
          ...
          if (response.error) {
            const { error } = response;
            const { statusCode } = response.httpResponse;
            if (statusCode > 299) {
   ...
   */
        attemptFailEvent: function attemptFailEvent(request) {
          const monitoringEvent = this.apiAttemptEvent(request);
          const { response } = request;
          const { error } = response;
   ...
   */
        attachMonitoringEmitter: function attachMonitoringEmitter(request) {
          let attemptTimestamp; // timestamp marking the beginning of a request attempt
          let attemptStartRealTime; // Start time of request attempt. Used to calculating attemptLatency
          let attemptLatency; // latency from request sent out to http response reaching SDK
          let callStartRealTime; // Start time of API call. Used to calculating API call latency
          let attemptCount = 0; // request.retryCount is not reliable here
          let region; // region cache region for each attempt since it can be updated in plase (e.g. s3)
          let callTimestamp; // timestamp when the request is created
          const self = this;
          const addToHead = true;
          ...
          request.on('validateResponse', () => {
            attemptLatency = Math.round(AWS.util.realClock.now() - attemptStartRealTime);
          });
          request.addNamedListener('API_CALL_ATTEMPT', 'success', () => {
            const apiAttemptEvent = self.apiAttemptEvent(request);
            apiAttemptEvent.Timestamp = attemptTimestamp;
            apiAttemptEvent.AttemptLatency = attemptLatency >= 0 ? attemptLatency : 0;
            apiAttemptEvent.Region = region;
            self.emit('apiCallAttempt', [apiAttemptEvent]);
          });
          request.addNamedListener('API_CALL_ATTEMPT_RETRY', 'retry', () => {
            const apiAttemptEvent = self.attemptFailEvent(request);
            apiAttemptEvent.Timestamp = attemptTimestamp;
        ...
        || Math.round(AWS.util.realClock.now() - attemptStartRealTime);
          ...
          request.addNamedListener('API_CALL', 'complete', () => {
            const apiCallEvent = self.apiCallEvent(request);
            apiCallEvent.AttemptCount = attemptCount;
            if (apiCallEvent.AttemptCount <= 0) return;
            apiCallEvent.Timestamp = callTimestamp;
            const latency = Math.round(AWS.util.realClock.now() - callStartRealTime);
   ...
   */
        paginationConfig: function paginationConfig(operation, throwException) {
          const { paginator } = this.api.operations[operation];
          if (!paginator) {
            if (throwException) {
              const e = new Error();
   ...
   */
        defineMethods: function defineMethods(svc) {
          AWS.util.each(svc.prototype.api.operations, (method) => {
            if (svc.prototype[method]) return;
            const operation = svc.prototype.api.operations[method];
   ...
   */
        defineService: function defineService(serviceIdentifier, versions, features) {
          ...
          const svc = inherit(AWS.Service, features || {});

          if (typeof serviceIdentifier === 'string') {
            AWS.Service.addVersions(svc, versions);

            const identifier = svc.serviceIdentifier || serviceIdentifier;
          ...
          if (!this.prototype.publisher && AWS.util.clientSideMonitoring) {
            const { Publisher } = AWS.util.clientSideMonitoring;
            const { configProvider } = AWS.util.clientSideMonitoring;
            const publisherConfig = configProvider();
   ...
   */
        addDefaultMonitoringListeners: function addDefaultMonitoringListeners(attachOn) {
          attachOn.addNamedListener('MONITOR_EVENTS_BUBBLE', 'apiCallAttempt', (event) => {
            const baseClass = Object.getPrototypeOf(attachOn);
            if (baseClass._events) baseClass.emit('apiCallAttempt', [event]);
          });
          attachOn.addNamedListener('CALL_EVENTS_BUBBLE', 'apiCall', (event) => {
            const baseClass = Object.getPrototypeOf(attachOn);
 ...
 */
   ...
   */
    ...
    /***/ ((__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const resolveRegionalEndpointsFlag = __nccwpck_require__(5566);
      const ENV_REGIONAL_ENDPOINT_ENABLED = 'AWS_STS_REGIONAL_ENDPOINTS';
      const CONFIG_REGIONAL_ENDPOINT_ENABLED = 'sts_regional_endpoints';
   ...
   */
      ...
      && service.isGlobalEndpoint
            ...
            const insertPoint = config.endpoint.indexOf('.amazonaws.com');
            const regionalEndpoint = `${config.endpoint.substring(0, insertPoint)
    ...
    /***/ 9697:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { IniLoader } = __nccwpck_require__(5417);
      /**
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      function parseFile(filename, isConfig) {
        const content = AWS.util.ini.parse(AWS.util.readFileSync(filename));
        const tmpContent = {};
        Object.keys(content).forEach((profileName) => {
 ...
 */
        loadFrom: function loadFrom(options) {
          options = options || {};
          const isConfig = options.isConfig === true;
          const filename = options.filename || this.getDefaultFilePath(isConfig);
          if (!this.resolvedProfiles[filename]) {
            const fileContent = this.parseFile(filename, isConfig);
 ...
 */
      function signedUrlBuilder(request) {
        const expires = request.httpRequest.headers[expiresHeader];
        const signerClass = request.service.getSignerClass(request);
        ...
        if (signerClass === AWS.Signers.V4) {
          if (expires > 604800) { // one week expiry is invalid
            const message = 'Presigning does not support expiry time greater '
                    + 'than a week with SigV4 signing.';
            throw AWS.util.error(new Error(), {
              code: 'InvalidExpiryTime', message, retryable: false,
            });
          }
          request.httpRequest.headers[expiresHeader] = expires;
        } else if (signerClass === AWS.Signers.S3) {
          const now = request.service ? request.service.getSkewCorrectedDate() : AWS.util.date.getDate();
 ...
 */
      function signedUrlSigner(request) {
        const { endpoint } = request.httpRequest;
        const parsedUrl = AWS.util.urlParse(request.httpRequest.path);
        let queryParams = {};
        ...
        let auth = request.httpRequest.headers.Authorization.split(' ');
        if (auth[0] === 'AWS') {
          auth = auth[1].split(':');
          queryParams.Signature = auth.pop();
          queryParams.AWSAccessKeyId = auth.join(':');

          AWS.util.each(request.httpRequest.headers, (key, value) => {
          ...
          auth.shift();
          const rest = auth.join(' ');
          const signature = rest.match(/Signature=(.*?)(?:,|\s|\r?\n|$)/)[1];
 ...
 */
   ...
   */
        ...
        addAuthorization: function addAuthorization(credentials, date) {
          ...
          const signature = this.sign(credentials.secretAccessKey, this.stringToSign());
          const auth = `AWS ${credentials.accessKeyId}:${signature}`;
        ...
        stringToSign: function stringToSign() {
          ...
          const headers = this.canonicalizedAmzHeaders();
        ...
        canonicalizedAmzHeaders: function canonicalizedAmzHeaders() {
          ...
          AWS.util.each(this.request.headers, (name) => {
            if (name.match(/^x-amz-/i)) { amzHeaders.push(name); }
          });

          amzHeaders.sort((a, b) => (a.toLowerCase() < b.toLowerCase() ? -1 : 1));
        ...
        canonicalizedResource: function canonicalizedResource() {
          ...
          if (querystring) {
            ...
            if (resources.length) {
              querystring = [];
              AWS.util.arrayEach(resources, (res) => {
 ...
 */
      AWS.Signers.V3 = inherit(AWS.Signers.RequestSigner, {
        addAuthorization: function addAuthorization(credentials, date) {
          const datetime = AWS.util.date.rfc822(date);
      ...
      + `Signature=${this.signature(credentials)}`;
        ...
        signedHeaders: function signedHeaders() {
          const headers = [];
          AWS.util.arrayEach(this.headersToSign(), (h) => {
        ...
        headersToSign: function headersToSign() {
          const headers = [];
          AWS.util.each(this.request.headers, (k) => {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const AWS = __nccwpck_require__(8437);
      const v4Credentials = __nccwpck_require__(2660);
      const { inherit } = AWS.util;
 ...
 */
      AWS.Signers.V4 = inherit(AWS.Signers.RequestSigner, {
        ...
        addAuthorization: function addAuthorization(credentials, date) {
          const datetime = AWS.util.date.iso8601(date).replace(/[:\-]|\.\d{3}/g, '');
        ...
        canonicalHeaders: function canonicalHeaders() {
          const headers = [];
          AWS.util.each.call(this, this.request.headers, (key, item) => {
 ...
 */
   ...
   */
        getSigningKey: function getSigningKey(
          ...
          const credsIdentifier = AWS.util.crypto
          ...
          const signingKey = AWS.util.crypto.hmac(kService, v4Identifier, 'buffer');
          if (shouldCache) {
   ...
   */
    ...
    /***/ ((module) => {
      ...
      AcceptorStateMachine.prototype.runTo = function runTo(finalState, done, bindObject, inputError) {
        ...
        const self = this;
        const state = self.states[self.currentState];
        state.fn.call(bindObject || self, inputError, (err) => {
          if (err) {
 ...
 */
      var util = {
        ...
        userAgent: function userAgent() {
          const name = util.environment;
          let agent = `aws-sdk-${name}/${__nccwpck_require__(8437).VERSION}`;
        ...
        uriEscape: function uriEscape(string) {
          ...
          output = output.replace(/[*]/g, (ch) => `%${ch.charCodeAt(0).toString(16).toUpperCase()}`);
        ...
        uriEscapePath: function uriEscapePath(string) {
          const parts = [];
          util.arrayEach(string.split('/'), (part) => {
        ...
        queryParamsToString: function queryParamsToString(params) {
          const items = [];
          const escape = util.uriEscape;
          const sortedKeys = Object.keys(params).sort();

          util.arrayEach(sortedKeys, (name) => {
            const value = params[name];
            const ename = escape(name);
            let result = `${ename}=`;
            if (Array.isArray(value)) {
              const vals = [];
              util.arrayEach(value, (item) => { vals.push(escape(item)); });
     ...
     */
          ...
          alloc(size, fill, encoding) {
            ...
            const buf = new util.Buffer(size);
          ...
          toStream: function toStream(buffer) {
            ...
            const readable = new (util.stream.Readable)();
            let pos = 0;
     ...
     */
        ...
        string: {
          byteLength: function byteLength(string) {
            ...
            } if (typeof string.size === 'number') {
              return string.size;
            } if (typeof string.path === 'string') {
     ...
     */
          ...
          parseTimestamp: function parseTimestamp(value) {
            if (typeof value === 'number') { // unix timestamp (number)
              ...
              return new Date(value * 1000);
            } if (value.match(/^\d{4}/)) { // iso8601
              return new Date(value);
            } if (value.match(/^\w{3},/)) { // rfc822
              return new Date(value);
            }
            throw util.error(
        ...
        crypto: {
          ...
          crc32: function crc32(data) {
            const tbl = util.crypto.crc32Table;
            let crc = 0 ^ -1;
          ...
          hash(algorithm, data, digest, callback) {
            const hash = util.crypto.createHash(algorithm);
            if (!digest) { digest = 'binary'; }
            if (digest === 'buffer') { digest = undefined; }
            if (typeof data === 'string') data = util.buffer.toBuffer(data);
            const sliceFn = util.arraySliceFn(data);
            let isBuffer = util.Buffer.isBuffer(data);
          ...
          && typeof data.on === 'function' && !isBuffer) {
              ...
              data.on('end', () => { callback(null, hash.digest(digest)); });
              ...
              reader.onload = function () {
                const buf = new util.Buffer(new Uint8Array(reader.result));
                hash.update(buf);
                index += buf.length;
   ...
   */
        inherit: function inherit(klass, features) {
          ...
          if (features === undefined) {
            ...
            const ctor = function ConstructorWrapper() {};
   ...
   */
        mixin: function mixin() {
          const klass = arguments[0];
          for (let i = 1; i < arguments.length; i++) {
            // jshint forin:false
            for (const prop in arguments[i].prototype) {
              const fn = arguments[i].prototype[prop];
              if (prop !== 'constructor') {
   ...
   */
        hideProperties: function hideProperties(obj, props) {
          ...
          util.arrayEach(props, (key) => {
            Object.defineProperty(obj, key, { enumerable: false, writable: true, configurable: true });
          });
        },
   ...
   */
        hoistPayloadMember: function hoistPayloadMember(resp) {
          ...
          const operation = req.service.api.operations[operationName];
          const { output } = operation;
          if (output.payload && !operation.hasEventOutput) {
            const payloadMember = output.members[output.payload];
            const responsePayload = resp.data[output.payload];
            if (payloadMember.type === 'structure') {
              util.each(responsePayload, (key, value) => {
   ...
   */
        computeSha256: function computeSha256(body, done) {
          ...
          util.crypto.sha256(body, 'hex', (err, sha) => {
            if (err) done(err);
            else done(null, sha);
          });
        },
   ...
   */
        extractRequestId: function extractRequestId(resp) {
          let requestId = resp.httpResponse.headers['x-amz-request-id']
   ...
   */
        addPromises: function addPromises(constructors, PromiseDependency) {
          ...
          for (let ind = 0; ind < constructors.length; ind++) {
            const constructor = constructors[ind];
            if (deletePromises) {
   ...
   */
        calculateRetryDelay: function calculateRetryDelay(retryCount, retryDelayOptions, err) {
          ...
          const customBackoff = retryDelayOptions.customBackoff || null;
          if (typeof customBackoff === 'function') {
            return customBackoff(retryCount, err);
          }
          const base = typeof retryDelayOptions.base === 'number' ? retryDelayOptions.base : 100;
          const delay = Math.random() * (2 ** retryCount * base);
          return delay;
        },
        ...
        handleRequestWithRetries: function handleRequestWithRetries(httpRequest, options, cb) {
          ...
          const errCallback = function (err) {
            ...
            if (err && err.retryable && retryCount < maxRetries) {
              const delay = util.calculateRetryDelay(retryCount, options.retryDelayOptions, err);
              if (delay >= 0) {
                retryCount++;
          ...
          var sendRequest = function () {
            let data = '';
            http.handleRequest(httpRequest, httpOptions, (httpResponse) => {
              httpResponse.on('data', (chunk) => { data += chunk.toString(); });
              httpResponse.on('end', () => {
                const { statusCode } = httpResponse;
                if (statusCode < 300) {
                  cb(null, data);
                } else {
                  const retryAfter = parseInt(httpResponse.headers['retry-after'], 10) * 1000 || 0;
                  const err = util.error(
                    new Error(),
                    {
                      statusCode,
   ...
   */
        convertPayloadToString: function convertPayloadToString(resp) {
          const req = resp.request;
          const { operation } = req;
          const rules = req.service.api.operations[operation].output || {};
   ...
   */
        getRequestPayloadShape: function getRequestPayloadShape(req) {
          const { operations } = req.service.api;
     ...
     */
          function objectAssign(target, source) {
            for (let i = 0, keys = Object.keys(source); i < keys.length; i++) {
 ...
 */
    ...
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const util = __nccwpck_require__(7985);
      const { XmlNode } = __nccwpck_require__(397);
      const { XmlText } = __nccwpck_require__(971);

      function XmlBuilder() { }

      XmlBuilder.prototype.toXML = function (params, shape, rootElement, noEmpty) {
        const xml = new XmlNode(rootElement);
      ...
      function serializeStructure(xml, params, shape) {
        util.arrayEach(shape.memberNames, (memberName) => {
          const memberShape = shape.members[memberName];
          if (memberShape.location !== 'body') return;

          const value = params[memberName];
          const { name } = memberShape;
          if (value !== undefined && value !== null) {
            if (memberShape.isXmlAttribute) {
              ...
              const element = new XmlNode(name);
      ...
      function serializeMap(xml, map, shape) {
        const xmlKey = shape.key.name || 'key';
        const xmlValue = shape.value.name || 'value';

        util.each(map, (key, value) => {
          const entry = new XmlNode(shape.flattened ? shape.name : 'entry');
          xml.addChildNode(entry);

          const entryKey = new XmlNode(xmlKey);
          const entryValue = new XmlNode(xmlValue);
      ...
      function serializeList(xml, list, shape) {
        if (shape.flattened) {
          util.arrayEach(list, (value) => {
            const name = shape.member.name || shape.name;
            const element = new XmlNode(name);
            xml.addChildNode(element);
          ...
          util.arrayEach(list, (value) => {
            const name = shape.member.name || 'member';
            const element = new XmlNode(name);
            xml.addChildNode(element);
            serialize(element, value, shape.member);
          });
 ...
 */
      ...
      NodeXmlParser.prototype.parse = function (xml, shape) {
        ...
        if (result) {
          const data = parseXml(result, shape);
      ...
      function parseStructure(xml, shape) {
        ...
        util.each(shape.members, (memberName, memberShape) => {
          const xmlName = memberShape.name;
          if (Object.prototype.hasOwnProperty.call(xml, xmlName) && Array.isArray(xml[xmlName])) {
            let xmlChild = xml[xmlName];
      ...
      function parseMap(xml, shape) {
        ...
        const xmlKey = shape.key.name || 'key';
        const xmlValue = shape.value.name || 'value';
        const iterable = shape.flattened ? xml : xml.entry;

        if (Array.isArray(iterable)) {
          util.arrayEach(iterable, (child) => {
      ...
      function parseList(xml, shape) {
        ...
        const name = shape.member.name || 'member';
        if (shape.flattened) {
          util.arrayEach(xml, (xmlChild) => {
            data.push(parseXml(xmlChild, shape.member));
          });
        } else if (xml && Array.isArray(xml[name])) {
          util.arrayEach(xml[name], (child) => {
      ...
      function parseUnknown(xml) {
        ...
        // empty object
        const keys = Object.keys(xml); let
          i;
 ...
 */
    ...
    /***/ 397:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { escapeAttribute } = __nccwpck_require__(8241);
 ...
 */
      ...
      XmlNode.prototype.toString = function () {
        ...
        for (let i = 0, attributeNames = Object.keys(attributes); i < attributeNames.length; i++) {
 ...
 */
    ...
    /***/ 971:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const { escapeElement } = __nccwpck_require__(8464);
 ...
 */
    ...
    /***/ ((__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      const LRU_1 = __nccwpck_require__(7710);
      const CACHE_SIZE = 1000;
      /**
 * Inspired node-lru-cache[https://github.com/isaacs/node-lru-cache]
 */
      const EndpointCache = /** @class */ (function () {
        ...
        EndpointCache.getKeyString = function (key) {
          const identifiers = [];
          const identifierNames = Object.keys(key).sort();
          for (let i = 0; i < identifierNames.length; i++) {
            const identifierName = identifierNames[i];
    ...
    /***/ ((__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', ({ value: true }));
      const LinkedListNode = /** @class */ (function () {
    ...
    /***/ ((__unused_webpack_module, exports) => {
      (function (exports) {
        ...
        TreeInterpreter.prototype = {
          ...
          visit(node, value) {
            let matched; let current; let result; let first; let second; let field; let left; let right; let collected; let
              i;
            switch (node.type) {
              case 'Field':
                if (value === null) {
    ...
    /***/ 2155:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const v1 = __nccwpck_require__(8749);
      const v4 = __nccwpck_require__(824);
 ...
 */
    ...
    /***/ 8749:
    /***/ ((module, __unused_webpack_exports, __nccwpck_require__) => {
      const rng = __nccwpck_require__(5859);
      const bytesToUuid = __nccwpck_require__(2707);
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let builder; let defaults; let escapeCDATA; let requiresCDATA; let wrapCDATA;
        ...
        exports.Builder = (function () {
          ...
          Builder.prototype.buildObject = function (rootObj) {
            let attrkey; let charkey; let render; let rootElement; let
              rootName;
            ...
            render = (function (_this) {
              return function (element, obj) {
                let attr; let child; let entry; let index; let key; let
                  value;
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let bom; let defaults; let events; let isEmpty; let processItem; let processors; let sax; let setImmediate;
        ...
        exports.Parser = (function (superClass) {
          ...
          Parser.prototype.reset = function () {
            let attrkey; let charkey; let ontext; let
              stack;
            ...
            this.saxParser.onopentag = (function (_this) {
              return function (node) {
                let key; let newValue; let obj; let processedKey; let
                  ref;
                obj = {};
                obj[charkey] = '';
            ...
            this.saxParser.onclosetag = (function (_this) {
              return function () {
                let cdata; let emptyStr; let key; let node; let nodeName; let obj; let objClone; let old; let s; let
                  xpath;
                obj = stack.pop();
                nodeName = obj['#name'];
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let builder; let defaults; let parser; let processors;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let assign; let isArray; let isEmpty; let isFunction; let isObject; let isPlainObject;
        const { slice } = [];
        const hasProp = {}.hasOwnProperty;

        assign = function () {
          let i; let key; let len; let source; let sources; let
            target;
          target = arguments[0], sources = arguments.length >= 2 ? slice.call(arguments, 1) : [];
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDTDEntity; let XMLNode; let isObject;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDTDNotation; let XMLNode;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDeclaration; let XMLNode; let isObject;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDTDAttList; let XMLDTDElement; let XMLDTDEntity; let XMLDTDNotation; let XMLDocType; let XMLNode; let isObject;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDocument; let XMLNode; let XMLStringWriter; let XMLStringifier; let isPlainObject;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLAttribute; let XMLCData; let XMLComment; let XMLDTDAttList; let XMLDTDElement; let XMLDTDEntity; let XMLDTDNotation; let XMLDeclaration; let XMLDocType; let XMLDocumentCB; let XMLElement; let XMLProcessingInstruction; let XMLRaw; let XMLStringWriter; let XMLStringifier; let XMLText; let isFunction; let isObject; let isPlainObject; let ref;
        const hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLDocumentCB = (function () {
          ...
          XMLDocumentCB.prototype.instruction = function (target, value) {
            let i; let insTarget; let insValue; let len; let
              node;
            this.openCurrent();
            if (target != null) {
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLAttribute; let XMLElement; let XMLNode; let isFunction; let isObject; let ref;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLElement = (function (superClass) {
          ...
          XMLElement.prototype.clone = function () {
            let att; let attName; let clonedSelf; let
              ref1;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLCData; let XMLComment; let XMLDeclaration; let XMLDocType; let XMLElement; let XMLNode; let XMLProcessingInstruction; let XMLRaw; let XMLText; let isEmpty; let isFunction; let isObject; let ref;
        const hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLNode = (function () {
          ...
          XMLNode.prototype.element = function (name, attributes, text) {
            let childNode; let item; let j; let k; let key; let lastChild; let len; let len1; let ref1; let
              val;
            lastChild = null;
            if (attributes == null) {
              attributes = {};
          ...
          XMLNode.prototype.instruction = function (target, value) {
            let insTarget; let insValue; let instruction; let j; let
              len;
            if (target != null) {
              target = target.valueOf();
            }
          ...
          XMLNode.prototype.doctype = function (pubID, sysID) {
            let child; let doc; let doctype; let i; let j; let k; let len; let len1; let ref1; let
              ref2;
            doc = this.document();
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLNode; let XMLProcessingInstruction;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLCData; let XMLComment; let XMLDTDAttList; let XMLDTDElement; let XMLDTDEntity; let XMLDTDNotation; let XMLDeclaration; let XMLDocType; let XMLElement; let XMLProcessingInstruction; let XMLRaw; let XMLStreamWriter; let XMLText; let XMLWriterBase;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLStreamWriter = (function (superClass) {
          ...
          XMLStreamWriter.prototype.document = function (doc) {
            let child; let i; let j; let len; let len1; let ref; let ref1; let
              results;
            ref = doc.children;
          ...
          XMLStreamWriter.prototype.element = function (node, level) {
            let att; let child; let i; let len; let name; let ref; let ref1; let
              space;
            level || (level = 0);
            ...
            if (node.children.length === 0 || node.children.every((e) => e.value === '')) {
              if (this.allowEmpty) {
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLCData; let XMLComment; let XMLDTDAttList; let XMLDTDElement; let XMLDTDEntity; let XMLDTDNotation; let XMLDeclaration; let XMLDocType; let XMLElement; let XMLProcessingInstruction; let XMLRaw; let XMLStringWriter; let XMLText; let XMLWriterBase;
        const extend = function (child, parent) { for (const key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
        var hasProp = {}.hasOwnProperty;
        ...
        module.exports = XMLStringWriter = (function (superClass) {
          ...
          XMLStringWriter.prototype.document = function (doc) {
            let child; let i; let len; let r; let
              ref;
          ...
          XMLStringWriter.prototype.element = function (node, level) {
            let att; let child; let i; let j; let len; let len1; let name; let r; let ref; let ref1; let ref2; let space; let
              textispresentwasset;
            level || (level = 0);
      ...
      (function () {
        ...
        module.exports = XMLStringifier = (function () {
          ...
          XMLStringifier.prototype.attEscape = function (str) {
            let ampregex;
            ampregex = this.noDoubleEncoding ? /(?!&\S+;)&/g : /&/g;
            return str.replace(ampregex, '&amp;').replace(/</g, '&lt;').replace(/"/g, '&quot;').replace(/\t/g, '&#x9;')
              .replace(/\n/g, '&#xA;')
              .replace(/\r/g, '&#xD;');
          };
      ...
      (function () {
        ...
        module.exports = XMLWriterBase = (function () {
          function XMLWriterBase(options) {
            let key; let ref; let ref1; let ref2; let ref3; let ref4; let ref5; let ref6; let
              value;
            options || (options = {});
    ...
    /***/ (function (module, __unused_webpack_exports, __nccwpck_require__) {
      // Generated by CoffeeScript 1.12.7
      (function () {
        let XMLDocument; let XMLDocumentCB; let XMLStreamWriter; let XMLStringWriter; let assign; let isFunction; let
          ref;
  ...
  (() => {
    const Lambda = __nccwpck_require__(3321);
    const fs = __nccwpck_require__(7147);
